        ...
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 hidden lg:block" style={{ backgroundImage: 'url(/glitter.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>

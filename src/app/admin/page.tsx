...
import { RATIOS } from '@/lib/game-logic';

export default function AdminPage() {
  const initialRatios = {
    prompts: RATIOS.PROMPTS * 100,
    rules: RATIOS.RULES * 100,
    modifiers: RATIOS.MODIFIERS * 100,
  };
  ...
  return (
    <main className="container mx-auto p-4 lg:p-8">
      ...
      <CmsForm 
        initialData={{ ruleGroups, prompts, modifiers }} 
